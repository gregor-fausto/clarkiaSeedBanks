...
seedBagsData <- seedBagsData %>% dplyr::filter(site=="BG"|site=="BR")
viabilityRawData <- viabilityRawData %>% dplyr::filter(site=="BG"|site=="BR")
...
saveRDS(data,file=paste0(fileDirectory,"belowgroundDataAgeOneTwoTesting.rds"))
