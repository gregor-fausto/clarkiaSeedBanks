...
dataList[[i]] <- read_excel(paste0(directory,"Above_ground survival & fecundity 06-19.xlsx"), sheet = sheetVector[i], range = rangeVector[i],na = "NA")
}
...
```{r}
# fullSeedDataset <- seed20062010 %>%
#   dplyr::full_join(seed20112012) %>%
#   dplyr::full_join(seedUndamaged20132015) %>%
#   dplyr::full_join(seedDamaged20132015)
