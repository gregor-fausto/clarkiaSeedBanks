...
I last ran these on 05/28/20 at 7:38 AM. The files in this directory are now a copy of those in the shared Dropbox folder. For the time being, the copy of the files remains outside of the folder that gets updated on Git. 
...
From 2013-2018, there is data on the number of undamaged and damaged fruits on each plant in additional plots outside of permanent plots. These additional plots were sampled to supplement counts of fruits per plant from permanent plots. 
