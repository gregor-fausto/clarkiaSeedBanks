...
# seed bags ---------------------------------------------------------------
  ...
  for(i in 1:n_bag2){
    ...
    # alpha
    alpha_g2[i] ~ dnorm(mu0_g2[siteViab2[i]],tau0_g2[siteViab2[i]])
    alpha_v2[i] ~ dnorm(mu0_v2[siteViab2[i]],tau0_v2[siteViab2[i]])
  ...
  for(i in 1:n2){
    ...
    # alpha
    alpha_4[i] ~ dnorm(mu0_4[siteBags2[i]],tau0_4[siteBags2[i]])
    alpha_5[i] ~ dnorm(mu0_5[siteBags2[i]],tau0_5[siteBags2[i]])
    alpha_6[i] ~ dnorm(mu0_6[siteBags2[i]],tau0_6[siteBags2[i]])
