...
# Read in data
###########################################################################
seedBags<-readxl::read_xls(path="/Users/Gregor/Dropbox/Clarkia-LTREB/20_demography_sites/seed bag data.xls",
                              sheet = 1, col_names = TRUE)
viabilityEstimates<-readxl::read_xls(path="/Users/Gregor/Dropbox/projects/clarkiaScripts/code/reshapeDataScripts/germ_and_viability.xls",
                              sheet = 1, col_names = TRUE, range = "A1:M1691")
...
viabilityEstimates<-viabilityEstimates %>%
  ...
  dplyr::rename(notGerm='# not germinated') %>%
  dplyr::rename(percGerm='% Germination') %>%
  ...
  dplyr::rename(percViab='% Viability') %>%
...
s1s<- round(spread(s1,round,s1)[,2:4],digits=4)
apply(s1s,1,mean)
...
setwd("/Users/Gregor/Dropbox/projects/clarkiaScripts/data/reshapeData")
...
###########################################################################
setwd("/Users/Gregor/Dropbox/projects/clarkiaScripts/products/originalAnalysis")
