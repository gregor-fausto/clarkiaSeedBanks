...
\begin{figure}
    ...
    \begin{subfigure}[htb]{6cm}
        \subfigimg[width=5.7cm,right]{A.}{../../figures/analysis/map.pdf} 
...
%       \colorbox{gray90}{\includegraphics[width=5.5cm]{../../figures/analysis/simulation-1.pdf}%<---
%       }
%       \colorbox{gray90}{\includegraphics[width=5.5cm]{../../figures/analysis/simulation-2.pdf}%<---
%       } 
%   	\end{subfigure}
%      \end{figure}
