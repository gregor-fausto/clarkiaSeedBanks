...
\end{align}
%
We implement the model with a non-centered parameterization at the year-level because this led to improved converge diagnostics. In each model, we obtain the population-level posterior distribution probability of success (the $\theta$s) by marginalizing across years and taking the inverse logit.
...
\begin{tikzpicture}[
  ...
  \end{tikzpicture}
  \caption{Diagram of data from the seed bag experiments and viability trials.}\label{seedexperiments}
