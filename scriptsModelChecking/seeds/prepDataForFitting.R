...
viabilityRawDataRefTable<-viabilityRawData1 %>%
  dplyr::left_join(referenceTable,by="id")
...
#seedBagsData1 <- seedBagsData1 %>% dplyr::filter(siteBags=="S22")
#seedBagsData2 <- seedBagsData2 %>% dplyr::filter(siteBags2=="S22")
#viabilityRawData1 <- viabilityRawData1 %>% dplyr::filter(siteViab=="S22") 
#viabilityRawData2 <- viabilityRawData2 %>% dplyr::filter(siteViab2=="S22")

saveRDS(viabilityRawData1,"~/Dropbox/clarkiaSeedBanks/scriptsModelChecking/seeds/viabilityRawData1.RDS")
saveRDS(seedBagsData1,"~/Dropbox/clarkiaSeedBanks/scriptsModelChecking/seeds/seedBagsRawData.RDS")
