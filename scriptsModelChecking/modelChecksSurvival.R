...
pdf(file="~/Dropbox/clarkiaSeedBanks/products/figures/modelChecks/seedlingSurvival-ppc-population.pdf",height=6,width=6)
...
pdf(file="~/Dropbox/clarkiaSeedBanks/products/figures/modelChecks/seedlingSurvival-pvals.pdf",height=6,width=6)
