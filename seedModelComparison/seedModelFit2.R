...
# # tuning (n.adapt)
jm = jags.model(paste0(dir,"jagsNegexpAgegerm.R"), data = data, n.adapt = n.adapt)
              #  inits = inits,
...
abline(h=mean(MCMCchains(samples.rjags,"g2")),lty=2,col=colors[2])
