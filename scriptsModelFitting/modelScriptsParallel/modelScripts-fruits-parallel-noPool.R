...
initsFun = function(){temp = list(initsMu(rows = data$n_site,cols=data$n_year), 
...
saveRDS(samples.rjags,file=paste0(fileDirectory,"fruitsSamples-noPool.rds"))
saveRDS(data,file=paste0(fileDirectory,"fruitsData-noPool.rds"))
