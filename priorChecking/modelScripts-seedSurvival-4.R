...
# exponential
jmExAg = jags.model(paste0(dir,"binomialLikelihood-logLink-expDecay-4.R"), data = data, n.adapt = n.adapt,
                    n.chains=2)
...
#year1
par(mfrow=c(1,3))
plot(data$months_pred,y_prior.pred.jmExAg[1,],type='n',ylim=c(0,100))
for(i in 1:length(samples)){
  points(data$months_pred[1:6]+rnorm(1,0,sd=.01),
